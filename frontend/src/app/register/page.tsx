...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    name: "", dob: "", age: "", gender: "", phone: "", username: "", password: "", confirmPassword: "", aadhaar: ""
  });
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/50 border border-slate-200 rounded-lg py-2.5 pl-10 pr-4 focus:ring-2 focus:ring-pink-500 outline-none"
                    value={formData.aadhaar} onChange={(e) => setFormData({...formData, aadhaar: e.target.value})} required
                  />
                </div>
              </div>
              </div>
